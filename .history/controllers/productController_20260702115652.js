...
exports.brandListing = (req, res) => {
  ...
  db.query(sql, values, (err, results) => {
    ...
    // ============================================
    // SECOND QUERY - ALL PRODUCTS (FOR SIDEBAR)
    // ============================================
...
db.query(sql, values, (err, results) => {
    ...
    // Build filter options from filtered products
    const ratings = [
        ...new Set(results.map(item => item.rating).filter(Boolean))
    ];
    ...
    // -----------------------------------------
    // Build Distribution Board Filters
    // Use ALL products of this brand
    // -----------------------------------------
